    ...
    <footer className="d-flex flex-column align-items-center justify-content-center">
      <Container className="d-flex flex-column align-items-center justify-content-center p-1">
        <div className="d-flex flex-row align-items-center justify-content-center">
          ...
          <a className="mr-1 ml-1" href="https://github.com/billy-zeng/newsbucket-react"><i className="fab fa-github-square"></i></a>
          <a className="mr-1 ml-1" href="https://www.linkedin.com/in/billy-zeng/"><i className="fab fa-linkedin"></i></a>
        </div>
      </Container>
